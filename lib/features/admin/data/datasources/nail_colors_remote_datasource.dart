...
class NailColorsRemoteDatasourceImpl implements NailColorsRemoteDatasource {
  ...
  Future<List<NailColorModel>> getNailColors() async {
    try {
      AppLogger.info(
        'Buscando cores de esmalte do Supabase',
        'NailColorsRemoteDatasource',
      );
      ...
      AppLogger.error(
        'Erro ao buscar cores de esmalte',
        e,
        stack,
        'NailColorsRemoteDatasource',
      );
  ...
  @override
  Future<NailColorModel> addNailColor(
    NailColorModel model, {
    File? imageFile,
  }) async {
    try {
      AppLogger.info(
        'Adicionando cor de esmalte no Supabase',
        'NailColorsRemoteDatasource',
      );
      ...
      if (imageFile != null) {
        ...
        try {
          ...
          AppLogger.error(
            'Erro ao fazer upload da imagem, salvando sem URL',
            e,
            null,
            'NailColorsRemoteDatasource',
          );
      ...
      AppLogger.error(
        'Erro ao adicionar cor de esmalte',
        e,
        stack,
        'NailColorsRemoteDatasource',
      );
  ...
  Future<void> updateNailColor(NailColorModel model) async {
    try {
      AppLogger.info(
        'Atualizando cor de esmalte ID: ${model.id}',
        'NailColorsRemoteDatasource',
      );
      ...
      AppLogger.error(
        'Erro ao atualizar cor de esmalte ID: ${model.id}',
        e,
        stack,
        'NailColorsRemoteDatasource',
      );
