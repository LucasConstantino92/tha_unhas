    ...
    if (error != null) {
      if (error is AuthException) {
        ...
        if (msg.contains('invalid login credentials') ||
          ...
          cleanMessage =
              'Falha na autenticação. Verifique os dados fornecidos.';
        }
        ...
        if (code == '23505') {
          ...
          cleanMessage =
              'Não foi possível realizar esta ação devido a uma restrição de vínculo.';
        } else {
          cleanMessage =
              'Não foi possível processar a requisição no banco de dados.';
        }
  ...
  static String getCleanDetail(String errorText) {
    ...
    if (lower.contains('invalid login credentials') ||
      ...
      return 'Confirme seu e-mail antes de entrar.';
        ...
        lower.contains('unique_email')) {
      return 'Este e-mail já está cadastrado.';
    } else if (lower.contains('password should be') ||
